import { Text, TouchableOpacity, StyleSheet, Image, View, Dimensions, Animated, Pressable } from 'react-native'
...
const TestButton = ({ title, handlePress, textStyles, isLoading, buttonIcon }) => {
    return (
        <TouchableOpacity 
